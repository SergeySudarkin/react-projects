...
import logoPlus from "../../assets/Users/plus.svg"
...
export const User = ({ item, invites, checkInvite }) => {
    return <li className={styles.user}>
        ...
        <img onClick={() => checkInvite(item.id)} className={styles.action} src={invites.includes(item.id) ? logoMinus : logoPlus} alt="Action" />
    </li>
}